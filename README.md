...
| Day | Part 1 | Part 2 |
| :---: | :---: | :---:  |
| [Day 1](./src/bin/01.rs) | `132.4µs` | `231.9µs` |
| [Day 2](./src/bin/02.rs) | `101.3µs` | `99.0µs` |
| [Day 3](./src/bin/03.rs) | `326.8µs` | `98.6ms` |
| [Day 4](./src/bin/04.rs) | `215.2µs` | `214.6µs` |
| [Day 5](./src/bin/05.rs) | `38.5µs` | `823.4µs` |
